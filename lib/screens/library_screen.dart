                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  'വി. മർത്തമറിയം യാക്കോബായ സുറിയാനി കത്തീഡ്രൽ',
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: const Color(0xFF120C07),
                                    fontSize: compact ? 4.3 : 5.7,
                                    fontWeight: FontWeight.w900,
                                  ),
                                ),
                                SizedBox(height: compact ? 1 : 2),
                                Text(
                                  'പള്ളിക്കര, കുമാരപുരം പി. ഒ. 683 565',
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: const Color(0xFF21170E),
                                    fontSize: compact ? 3.4 : 4.5,
                                    fontWeight: FontWeight.w700,
                                  ),
                                ),
                                SizedBox(height: compact ? 1 : 2),
                                Text(
                                  'ഫാമിലി യൂണിറ്റ് കേന്ദ്രസമിതി പ്രസിദ്ധീകരണം',
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: const Color(0xFF21170E),
                                    fontSize: compact ? 3.7 : 4.9,
                                    fontWeight: FontWeight.w800,
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  color: const Color(0xD908090A),
                                  child: FittedBox(
                                    fit: BoxFit.scaleDown,
                                    child: Text(
                                      '${volume.coverIssueLabel}  Free and Private Circulation only     Serial No. ${volume.number}',
                                      maxLines: 1,
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: compact ? 4.4 : 5.8,
                                        fontWeight: FontWeight.w800,
                                      ),
                                    ),
                                  ),
